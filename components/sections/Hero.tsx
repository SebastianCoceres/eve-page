...
export const Hero = () => {
    ...
    return (
        <section id="home" className="relative snap-always snap-center flex flex-col justify-center items-center flex-fill min-h-screen">
            ...
            <div ref={ref} className="flex container md:max-w-6xl mx-auto">
                <div className="md:w-2/3 flex flex-col justify-center items-start">
                    <div className="text-center">
                        ...
                        <Heading is="h2" className="relative z-[1] text-center md:text-left">
                    ...
                    <Button variant={"outline"} size={"xl"} className={"mt-4"} rounded={"full"}>
